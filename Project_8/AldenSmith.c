...
//////////////////////////////////////////////////////////////////////////////// 0
// This should have a cast in front of the malloc
// I am surprised you are not getting at least a warning from this
    newNode = malloc(sizeof(TreeNodeType));
...
TreeNodeType *insert( TreeNodeType *wkgPtr, const TreeNodeType inData )
{
    ...
    // If null/empty tree or same, result = 0
    comparison = compareRoomNumbers(inData.roomNumber, wkgPtr->roomNumber);

    // if data is empty tree or the same, insert here
    if (comparison == 0)
    {
////////////////////////////////////////////////////////////////////////////////
// two differing conditions: 1) empty tree, where you have create a node, or
// 2) the values are the same, where you overwrite the previous data
// Need to separate these out
    ...
    else if (comparison > 0)
    {
        ...
        else
        {
            // recurse right
////////////////////////////////////////////////////////////////////////////////
// you have to return the results of the recursion back to the calling function
// assigned to the appropriate child's pointer
