...
Dependencies: none
*/
int findMax( int one, int other ); // if one > other, return one: else return other
...
Device input/---: none
Device output/---: none
Dependencies: variable options, findMax
*/
int findTreeHeight( AvlTreeNodeType *wkgPtr ); // check if not null: return below me +1
